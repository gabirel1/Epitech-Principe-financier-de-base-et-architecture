...
NEW_ORDER_SINGLE_1 = f"8=FIX.4.2{chr(1)}9=121{chr(1)}35=D{chr(1)}49=11111{chr(1)}56=SERVER{chr(1)}34=2{chr(1)}52=20240112-01:10:28.888{chr(1)}11=1{chr(1)}21=3{chr(1)}38=10{chr(1)}40=2{chr(1)}44=100{chr(1)}54=3{chr(1)}55=EUR/USD{chr(1)}60=20210201-10:00:000{chr(1)}10=010{chr(1)}"
NEW_ORDER_SINGLE_2 = f"8=FIX.4.2{chr(1)}9=120{chr(1)}35=D{chr(1)}49=11111{chr(1)}56=SERVER{chr(1)}34=3{chr(1)}52=20240112-01:10:28.888{chr(1)}11=2{chr(1)}21=3{chr(1)}38=5{chr(1)}40=2{chr(1)}44=100{chr(1)}54=4{chr(1)}55=EUR/USD{chr(1)}60=20210201-10:00:000{chr(1)}10=224{chr(1)}"
NEW_ORDER_SINGLE_3 = f"8=FIX.4.2{chr(1)}9=121{chr(1)}35=D{chr(1)}49=11111{chr(1)}56=SERVER{chr(1)}34=4{chr(1)}52=20240112-01:10:28.888{chr(1)}11=3{chr(1)}21=3{chr(1)}38=50{chr(1)}40=2{chr(1)}44=100{chr(1)}54=3{chr(1)}55=EUR/USD{chr(1)}60=20210201-10:00:000{chr(1)}10=018{chr(1)}"
