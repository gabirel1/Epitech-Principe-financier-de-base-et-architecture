...
NEW_ORDER_SINGLE_MSG = f"8=FIX.4.2{chr(1)}9=133{chr(1)}35=D{chr(1)}49=CLIENT_2{chr(1)}56=MyMarket{chr(1)}34=2{chr(1)}52=20240128-14:51:24.268{chr(1)}11=123123{chr(1)}21=3{chr(1)}38=700{chr(1)}40=2{chr(1)}44=23.42{chr(1)}54=3{chr(1)}55=GOLD{chr(1)}60=20210202-12:12:12.123{chr(1)}10=074{chr(1)}"
