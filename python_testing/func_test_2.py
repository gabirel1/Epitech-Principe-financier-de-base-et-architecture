...
NEW_ORDER_SINGLE_MSG = f"8=FIX.4.2{chr(1)}9=110{chr(1)}35=D{chr(1)}49=1{chr(1)}56=0{chr(1)}34=2{chr(1)}52=20240120-12:40:50.584{chr(1)}11=1{chr(1)}55=GOLD{chr(1)}54=3{chr(1)}38=100{chr(1)}40=2{chr(1)}44=1000{chr(1)}21=3{chr(1)}60=20201010-10:10:100{chr(1)}10=074{chr(1)}"
NEW_ORDER_SINGLE_MSG2 = f"8=FIX.4.2{chr(1)}9=110{chr(1)}35=D{chr(1)}49=1{chr(1)}56=0{chr(1)}34=3{chr(1)}52=20240120-12:40:50.584{chr(1)}11=2{chr(1)}55=GOLD{chr(1)}54=4{chr(1)}38=100{chr(1)}40=2{chr(1)}44=1400{chr(1)}21=3{chr(1)}60=20201010-10:10:100{chr(1)}10=081{chr(1)}"
ORDER_CANCEL_REPLACE_MSG = f"8=FIX.4.2{chr(1)}9=115{chr(1)}35=G{chr(1)}49=1{chr(1)}56=0{chr(1)}34=4{chr(1)}52=20240120-12:40:50.584{chr(1)}11=1{chr(1)}41=1{chr(1)}55=GOLD{chr(1)}54=3{chr(1)}38=100{chr(1)}40=2{chr(1)}44=1010{chr(1)}21=3{chr(1)}60=20201010-10:10:100{chr(1)}10=041{chr(1)}"
ORDER_CANCEL_REQUEST_MSG = f"8=FIX.4.2{chr(1)}9=90{chr(1)}35=F{chr(1)}49=1{chr(1)}56=0{chr(1)}34=5{chr(1)}52=20240120-12:40:50.584{chr(1)}41=2{chr(1)}11=2{chr(1)}55=GOLD{chr(1)}54=4{chr(1)}60=20201010-10:10:100{chr(1)}10=180{chr(1)}"
LOGOUT_MSG = f"8=FIX.4.2{chr(1)}9=45{chr(1)}35=5{chr(1)}49=1{chr(1)}56=0{chr(1)}34=6{chr(1)}52=20240120-12:40:50.584{chr(1)}10=054{chr(1)}"
