...
NEW_ORDER_SINGLE_MSG = f"8=FIX.4.2{chr(1)}9=133{chr(1)}35=D{chr(1)}49=CLIENT_2{chr(1)}56=MyMarket{chr(1)}34=2{chr(1)}52=20240127-10:30:06.785{chr(1)}11=123123{chr(1)}21=3{chr(1)}38=500{chr(1)}40=2{chr(1)}44=12.22{chr(1)}54=3{chr(1)}55=GOLD{chr(1)}60=20210202-12:12:12.123{chr(1)}10=064{chr(1)}"
...
try:
    ...
    print("waiting for CLIENT_1 to buy and market to send Execution Report\n")
    data = _socket.recv(1024).decode()
    print(f"Received message from server: '{data}'", "\n\n")
    response = decode_message(data)
