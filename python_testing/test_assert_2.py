...
NEW_ORDER_SINGLE_3 = f"8=FIX.4.2{chr(1)}9=111{chr(1)}35=D{chr(1)}49=1{chr(1)}56=0{chr(1)}34=4{chr(1)}52=20240116-01:15:18.481{chr(1)}11=3{chr(1)}21=3{chr(1)}38=50{chr(1)}40=2{chr(1)}44=300{chr(1)}54=3{chr(1)}55=EUR/USD{chr(1)}60=20210201-10:00:000{chr(1)}10=219{chr(1)}"
LOGOUT_MSG = f"8=FIX.4.2{chr(1)}9=45{chr(1)}35=5{chr(1)}49=1{chr(1)}56=0{chr(1)}34=5{chr(1)}52=20240116-01:15:18.481{chr(1)}10=058{chr(1)}"
...
msg_list = [
    ...
    {"msg": NEW_ORDER_SINGLE_3, "name": "new_order2", "bid_state": [
        {"orders": 1, "price": 300, "quantity": 35},
        {"orders": 1, "price": 100, "quantity": 10}
    ], "ask_state": {"orders": 0, "price": 0, "quantity": 0}},
