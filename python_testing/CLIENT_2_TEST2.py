...
NEW_ORDER_SINGLE_MSG = f"8=FIX.4.2{chr(1)}9=131{chr(1)}35=D{chr(1)}49=CLIENT_2{chr(1)}56=MyMarket{chr(1)}34=2{chr(1)}52=20240126-23:28:25.215{chr(1)}11=2332{chr(1)}21=3{chr(1)}38=250{chr(1)}40=2{chr(1)}44=14.02{chr(1)}54=3{chr(1)}55=GOLD{chr(1)}60=20210202-12:12:12.123{chr(1)}10=221{chr(1)}"
...
try:
    ...
    assert response["44"] == "14.020000", f"New Order Single message failed. Expected Price(44) = 14.020000. Instead received: {response['44']}"
