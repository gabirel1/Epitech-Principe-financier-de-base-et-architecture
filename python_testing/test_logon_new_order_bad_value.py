...
NEW_ORDER_BAD_MSG = f"8=FIX.4.2{chr(1)}9=122{chr(1)}35=D{chr(1)}49=CLIENT{chr(1)}56=SERVER{chr(1)}34=2{chr(1)}52=20240112-19:06:49.787{chr(1)}11=2{chr(1)}21=3{chr(1)}38=10{chr(1)}40=2{chr(1)}44=100{chr(1)}54=10{chr(1)}55=EUR/USD{chr(1)}60=20210201-10:00:000{chr(1)}10=073{chr(1)}"
...
msg_list = [
    ...
    {"msg": NEW_ORDER_BAD_MSG, "name": "new_order_bad"},
