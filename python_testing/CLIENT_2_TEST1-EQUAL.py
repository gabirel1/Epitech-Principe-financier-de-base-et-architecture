...
NEW_ORDER_SINGLE_MSG = f"8=FIX.4.2{chr(1)}9=127{chr(1)}35=D{chr(1)}49=CLIENT_2{chr(1)}56=MyMarket{chr(1)}34=2{chr(1)}52=20240204-03:48:02.213{chr(1)}11=2{chr(1)}21=3{chr(1)}38=100{chr(1)}40=2{chr(1)}44=1000{chr(1)}54=3{chr(1)}55=GOLD{chr(1)}60=20210901-10:00:00.000{chr(1)}10=254{chr(1)}"
...
try:
    ...
    assert response["44"] == "1000.000000", f"New Order Single message failed. Expected Price(44) = 1200.000000. Instead received: {response['44']}"
