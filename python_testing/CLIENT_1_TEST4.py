...
NEW_ORDER_SINGLE_MSG = f"8=FIX.4.2{chr(1)}9=131{chr(1)}35=D{chr(1)}49=CLIENT_1{chr(1)}56=MyMarket{chr(1)}34=2{chr(1)}52=20240127-10:30:06.785{chr(1)}11=2332{chr(1)}21=3{chr(1)}38=250{chr(1)}40=2{chr(1)}44=10.03{chr(1)}54=4{chr(1)}55=GOLD{chr(1)}60=20210202-12:12:12.123{chr(1)}10=219{chr(1)}"
...
try:
    ...
    assert response["37"] == "2332", f"New Order Single message failed. Expected OrderID(37) = 2332. Instead received: {response['37']}"
    # not sure
    ...
    assert response["44"] == "10.030000", f"New Order Single message failed. Expected Price(44) = 10.030000. Instead received: {response['44']}"
