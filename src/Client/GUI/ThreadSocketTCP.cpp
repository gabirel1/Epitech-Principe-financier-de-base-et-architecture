...
ThreadSocketTCP::ThreadSocketTCP(const net::Ip &_ip, uint32_t _port, TCPInput &_input, TCPOutput &_output)
    : m_input(_input), m_output(_output), m_ip(_ip), m_port(_port)
{
    m_running = true;
